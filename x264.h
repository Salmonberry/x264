...
#define X264_CPU_SSE3               (1<<4)
#define X264_CPU_SSSE3              (1<<5)
#define X264_CPU_SSE4               (1<<6)  /* SSE4.1 */
#define X264_CPU_SSE42              (1<<7)  /* SSE4.2 */
#define X264_CPU_LZCNT              (1<<8)
...
#define X264_CPU_AVX2               (1<<13)
#define X264_CPU_AVX512             (1<<14) /* AVX-512 {F, CD, BW, DQ, VL}, requires OS support */
#define X264_CPU_BMI1               (1<<15)
#define X264_CPU_BMI2               (1<<16)
/* x86 modifiers */
...
#define X264_CPU_SLOW_CTZ           (1<<23) /* BSR/BSF x86 instructions are really slow on some CPUs */
#define X264_CPU_SLOW_ATOM          (1<<24) /* The Atom is terrible: slow SSE unaligned loads, slow
                                             * SIMD multiplies, slow SIMD variable shifts, slow pshufb,
                                             * cacheline split penalties -- gather everything here that
                                             * isn't shared by other CPUs to avoid making half a dozen
                                             * new SLOW flags. */
#define X264_CPU_SLOW_PSHUFB        (1<<25) /* such as on the Intel Atom */
#define X264_CPU_SLOW_PALIGNR       (1<<26) /* such as on the AMD Bobcat */
...
#define X264_AQ_AUTOMIX_BIASED       3
#define X264_AQ_AUTOMIX_MOD          4
